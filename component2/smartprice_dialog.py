...
from component.variable import V_global, get_dick, set_dick
...
class Smart_tijiaoDialog(wx.Dialog):
    ...
    def Second_tijiao_time_smart1(self, event):
        one_time2_smart1 = V_global.one_time2_smart1
        tem = self.second_tijiao_time_smart1.GetValue()
        timelist = V_global.timelist
        if int(tem * 10) in timelist:
            one_time2_smart1 = tem
            V_global.one_time2_smart1 = float(tem)
            V_global.one_realtime2_smart1 = gettime(one_time2_smart1) ## 计算得到的时间戳
    ...
    def Second_tijiao_pricediff_smart1(self, event):
        ...
        if select == u"提前100":
            V_global.one_advance_smart1 = 100
        elif select == u"提前200":
            V_global.one_advance_smart1 = 200
        elif select == u"提前300":
            V_global.one_advance_smart1 = 300
        else:
            V_global.one_advance_smart1 = 0
        self.update_strategy()
    ...
    def Second_tijiaoyanchi_time_smart1(self, event):
        ...
        if int(tem * 10) in yanchilist:
            V_global.one_delay_smart1 = float(tem)
            self.update_strategy()
        else:
            self.second_tijiaoyanchi_time_smart1.SetValue(one_delay_smart1)

    def Second_tijiao_time_smart2(self, event):
        one_time2_smart2 = V_global.one_time2_smart2
        tem = self.second_tijiao_time_smart2.GetValue()
        timelist = V_global.timelist
        if int(tem * 10) in timelist:
            one_time2_smart2 = tem
            V_global.one_time2_smart2 = float(tem)
            V_global.one_realtime2_smart2 = gettime(one_time2_smart2) ## 计算得到的时间戳
            self.update_strategy()
        else:
    ...
    def Second_tijiao_pricediff_smart2(self, event):
        ...
        if select == u"提前100":
            V_global.one_advance_smart2 = 100
        elif select == u"提前200":
            V_global.one_advance_smart2 = 200
        elif select == u"提前300":
            V_global.one_advance_smart2 = 300
        else:
            V_global.one_advance_smart2 = 0
        self.update_strategy()
    ...
    def Second_tijiao_time_smart3(self, event):
        ...
        if int(tem * 10) in timelist:
            ...
            V_global.one_time2_smart3 = float(tem)
            V_global.one_realtime2_smart3 = gettime(one_time2_smart3) ## 计算得到的时间戳
            self.update_strategy()
        else:
    ...
    def Second_tijiao_pricediff_smart3(self, event):
        ...
        if select == u"提前100":
            V_global.one_advance_smart3 = 100
        elif select == u"提前200":
            V_global.one_advance_smart3 = 200
        elif select == u"提前300":
            V_global.one_advance_smart3 = 300
        else:
            V_global.one_advance_smart3 = 0
        self.update_strategy()
    ...
    def Second_tijiaoyanchi_time_smart3(self, event):
        ...
        yanchilist = V_global.yanchilist
        if int(tem * 10) in yanchilist:
            V_global.one_delay_smart3 = float(tem)
            self.update_strategy()
        else:
            self.second_tijiaoyanchi_time_smart3.SetValue(one_delay_smart3)

    def Second_tijiao_time_smart(self, event):
        one_time2_smart = V_global.one_time2_smart
        tem = self.second_tijiao_time_smart.GetValue()
        timelist = V_global.timelist
        if int(tem * 10) in timelist:
            one_time2_smart = tem
            V_global.one_time2_smart = float(tem)
            V_global.one_realtime2_smart = gettime(one_time2_smart) ## 计算得到的时间戳
            self.update_strategy()
        else:
    ...
    def update_strategy(self):
        ...
        if strategy_type == '2':
            ...
            templist[1] = V_global.one_time1
            templist[2] = V_global.one_diff
            ...
            templist[1] = V_global.one_time1
            templist[2] = V_global.one_diff
            templist[3] = V_global.one_advance
            templist[4] = V_global.one_delay
            templist[5] = V_global.one_time2
            templist[6] = V_global.one_forcetijiao_on
            templist[7] = V_global.second_time1
            templist[8] = V_global.second_diff
    ...
    def init_dlg(self):
        ...
        if strategy_type == '2':
            ...
            V_global.one_realtime2_smart1 = gettime(strategy_list[11])
            V_global.one_realtime2_smart2 = gettime(strategy_list[14])
