...
class GuopaiFrame(wx.Frame):
    def __init__(self, parent, name, mainicon):  ##########版本号
        ...
        self.dianxin.SetFont(wx.Font(20, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))
        self.nodianxin.SetFont(wx.Font(20, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))
